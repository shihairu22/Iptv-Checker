...
test('isUrlSafe blocks private hosts by default but allows them when requested', () => {
...
test('rewriteHlsPlaylist rewrites segment lines and URI attributes', () => {
    const playlist = [
        '#EXTM3U',
    ...
    const rewritten = rewriteHlsPlaylist(playlist, 'https://media.example.com/path/master.m3u8');
